...
export async function initChangelog() {
  ...
  try {
    ...
    p.textContent = `Could not load changelog.md (${err.message || err}). If you opened this file directly, serve it over HTTP instead of file:// — e.g. "php -S localhost:8000".`;
